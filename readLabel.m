function objects = readLabel(label_dir,img_idx)
%Modified from kitti vision object detection dev_kit readLabels
%change to img_idx formatting

% parse input file
fid = fopen(fullfile(label_dir,sprintf('%s.txt',img_idx)));
